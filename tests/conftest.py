...
def _ensure_iceberg_available(spark) -> None:
    """
    ...
    try:
        ...
        # Broad Exception is intentional: Java exceptions from PySpark may not be subclasses of standard Python exceptions
